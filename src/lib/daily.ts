...
export const dailyPapers: DailyPaper[] = [
  {
    ...
    arxivId: "",
    paperUrl: "https://openai.com/index/designing-agents-to-resist-prompt-injection/",
    tags: ["AI Security", "Prompt Injection", "LLM Agents"],
    why: "Official OpenAI guidance reframes agent prompt injection as social engineering and focuses defenses on source-sink controls.",
    whyZh: "OpenAI 官方指南将智能体提示注入重新定义为社会工程问题，并把防御重点放在 source-sink 控制。",
    pick: true,
  ...
  },
  {
    ...
    authors: "Anthropic",
    arxivId: "",
    paperUrl: "https://www.anthropic.com/research/prompt-injection-defenses",
    tags: ["AI Security", "Prompt Injection", "Browser Agents"],
    why: "Anthropic's official browser-agent security writeup covers web-scale attack surfaces, classifiers, interventions, and red teaming.",
    whyZh: "Anthropic 官方浏览器智能体安全文章，覆盖 Web 攻击面、分类器、行为干预和红队。",
    pick: true,
  ...
  },
  {
    ...
    why: "System-layer defense separates trusted control flow from untrusted data and reports 77% secure task success on AgentDojo.",
    whyZh: "系统层防御将可信控制流与不可信数据分离，并在 AgentDojo 上实现 77% 安全任务成功率。",
    pick: true,
  ...
  },
  {
    ...
    arxivId: "",
    paperUrl: "https://www.microsoft.com/en-us/security/blog/2026/02/10/ai-recommendation-poisoning/",
    tags: ["AI Security", "Memory Poisoning", "Prompt Injection"],
    why: "Microsoft Defender's official security blog shows how helpful-looking AI links can prefill prompts that try to persistently bias assistant memory and future recommendations.",
    whyZh: "Microsoft Defender 官方安全博客揭示：看似有用的 AI 链接如何预填提示词，试图持久化污染助手记忆并影响未来推荐。",
    pick: true,
  ...
  },
  {
    ...
    arxivId: "2302.12173",
    tags: ["AI Security", "Prompt Injection", "LLM Agents"],
    why: "Defines indirect prompt injection: malicious instructions planted in retrieved data can steer LLM apps and tool calls.",
    whyZh: "定义间接提示注入：藏在检索数据中的恶意指令可以操纵 LLM 应用和工具调用。",
    pick: true,
...
export const visibleDailyPapers = dailyPapers.filter((paper) =>
  paper.tags.some((tag) => securityTags.has(tag))
);

export const allTags = Array.from(
  new Set(visibleDailyPapers.flatMap((p) => p.tags))
).sort();
